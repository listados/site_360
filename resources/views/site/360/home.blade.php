...
<head>
  ...
  <title>360° Listados</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{asset('img/favicon_360_listados.ico')}}" rel="icon">
...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <h1 class="mb-4">
                ...
                <span class="accent-text">360° Listados</span>
              </h1>
        ...
        <div id= "benefits" class="row stats-row gy-4 mt-5" data-aos="fade-up" data-aos-delay="500">
          <h2 class="" style="margin-left: 2rem">Com o 360° Listados você poderá...</h2>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4></h4>
                <p class="mb-0">
                  Ter acesso a um Dashboard de dados de todos os seus
                  tours virtuais</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4></h4>
                <p class="mb-0">Contar com um assistente para guiá-lo na criação dos tours</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4></h4>
                <p class="mb-0">Incorporar plantas baixas possibilitando uma nova visão de seus tours virtuais</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4></h4>
                <p class="mb-0">Publicar e compartilhar seus tours virtuais nas redes sociais</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Features Section -->
    <section id="step-by-step" class="features section">
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="tab-pane fade active show" id="features-tab-1">
            <div class="row">
              ...
              <div class="col-lg-5 order-1 order-lg-2 text-center">
                <img src="{{asset('img/planejamento.png')}}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane fade" id="features-tab-2">
            <div class="row">
              ...
              <div class="col-lg-5 order-1 order-lg-2 text-center">
                <img src="{{asset('img/suporte-camera.png')}}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
          ...
          <div class="tab-pane fade" id="features-tab-3">
            <div class="row">
              ...
              <div class="col-lg-5 order-1 order-lg-2 text-center">
                <img src="{{asset('img/publicar.png')}}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
          ...
          <div class="tab-pane fade" id="features-tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                <h3>Publicar</h3>
                <p class="fst-italic">
                  Após a construção e personalização do seu tour virtual, é possível compartilhar o seu imóvel para o mundo, proporcionando uma experiência incrível em suas redes sociais.
                </p>
                <ul>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4">
            ...
            <div class="feature-item text-end mb-5" data-aos="fade-right" data-aos-delay="200">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  <h3>Acesse em qualquer dispositivo</h3>
                  <p>O tour virtual do 360° Listados pode ser acessado em qualquer dispositivo, como computadores, tablets e smartphones, permitindo que você explore os ambientes de forma prática e sem restrições.</p>
                </div>
            ...
            <div class="feature-item text-end mb-5" data-aos="fade-right" data-aos-delay="300">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  <h3>Compartilhamento Fácil e Rápido</h3>
                  <p>Com apenas alguns toques, você pode compartilhar os tours virtuais via redes sociais, e-mail ou mensagens. Assim, mais pessoas podem visualizar os espaços de forma prática, sem precisar baixar aplicativos.</p>
                </div>
                <div class="feature-icon flex-shrink-0">
            ...
            <div class="feature-item text-end" data-aos="fade-right" data-aos-delay="400">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  ...
                  <p>O 360° Listados pode ser acessado por óculos de realidade virtual no mobile. Basta inserir o dispositivo em um VR headset compatível e explorar os ambientes como se estivesse presente.</p>
                </div>
                <div class="feature-icon flex-shrink-0">
          ...
          <div class="col-lg-4">
            ...
            <div class="feature-item mb-5" data-aos="fade-left" data-aos-delay="200">
              <div class="d-flex align-items-center gap-4">
                ...
                <div class="feature-content">
                  <h3>Acesso Rápido e Sem Instalação</h3>
                  <p>Visualize os tours virtuais instantaneamente, sem a necessidade de baixar aplicativos. Basta acessar o link pelo navegador do seu dispositivo e explorar os ambientes com total praticidade.</p>
                </div>
              </div>
            </div><!-- End .feature-item -->
            ...
            <div class="feature-item mb-5" data-aos="fade-left" data-aos-delay="300">
              <div class="d-flex align-items-center gap-4">
                ...
                <div class="feature-content">
                  ...
                  <p>O 360° Listados é totalmente responsivo. Seja em computadores, tablets ou smartphones, a plataforma se adapta automaticamente ao tamanho da tela, proporcionando visualização otimizada e navegação intuitiva.</p>
                </div>
              </div>
            </div><!-- End .feature-item -->
            ...
            <div class="feature-item" data-aos="fade-left" data-aos-delay="400">
              <div class="d-flex align-items-center gap-4">
                ...
                <div class="feature-content">
                  <h3>Compatibilidade com Navegadores</h3>
                  <p>O 360° Listados é compatível com os principais navegadores como Google Chrome, Mozilla Firefox, Microsoft Edge, Safari e outros. Dessa forma, você pode explorar os tours virtuais com total facilidade, independentemente do navegador que utiliza.</p>
                </div>
              </div>
            </div><!-- End .feature-item -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row content justify-content-center align-items-center position-relative">
          <div class="col-lg-10 mx-auto text-center">
            <h2 class="display-7 mb-4">Descubra uma nova forma de apresentar seus imóveis com o 360° Listados! Com planos flexíveis e recursos avançados, oferecemos a melhor experiência para você e seus clientes.

            </h2>
            <p class="mb-4"></p>
            <a href="#pricing" class="btn btn-cta">Ver Planos</a>
          </div>
    ...
    <section id="testimonials" class="testimonials section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Depoimentos</h2>
        <p>Veja o feedback de nossos clientes!</p>
      </div><!-- End Section Title -->
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="testimonial-item">
              ...
              <p>
                ...
                <span>A ferramenta de tour virtual superou minhas expectativas! Foi muito fácil adicionar imagens, vídeos e até plantas baixas ao meu tour. Agora posso apresentar meus imóveis de forma muito mais profissional.</span>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>Nunca imaginei que criar um tour virtual pudesse ser tão simples! A plataforma é intuitiva, e em poucos minutos eu já tinha meu primeiro imóvel pronto para exibição.</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>A plataforma me ajudou a transformar a forma como apresento meus empreendimentos. Agora, os clientes conseguem explorar cada espaço com total imersão, sem precisar de visitas presenciais iniciais.</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>Com o 360° Listados, consegui destacar meus imóveis de maneira interativa e inovadora. A ferramenta me permitiu personalizar cada detalhe e proporcionar uma experiência diferenciada para meus clientes.</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div><!-- End testimonial item -->
    ...
    <section id="services" class="services section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Serviços</h2>
        <p>Confira nossos serviços e comece a utilizá-los!</p>
      </div><!-- End Section Title -->
    ...
    <section id="pricing" class="pricing section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Planos</h2>
        <p>Escolha o plano ideal para o seu tour virtual e leve sua experiência para o próximo nível!</p>
      </div><!-- End Section Title -->
        ...
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="pricing-card">
              ...
              <p class="description">Experimente o 360° Listados por 90 dias grátis e transforme seus imóveis com tours virtuais incríveis!</p>

              <h4>Funcionalidades:</h4>
              <ul class="features-list">
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 5 tours virtuais
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 10 imagens por tour
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
              ...
              <a href="https://360.listados.com.br/backend/login.php" target="_blank" class="btn btn-primary">
                Acessar
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="pricing-card popular">
              ...
              <p class="description">Com o plano Business você poderá criar seus tours virtuais com uma infinidade de possibilidades!</p>

              <h4>Funcionalidades:</h4>
              <ul class="features-list">
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 200 tours virtuais
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 50 imagens por tour
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 200 conexões
              ...
              <a href="https://api.whatsapp.com/send?phone=5585998660078" target="_blank" class="btn btn-light">
                Comprar
                <i class="bi bi-arrow-right"></i>
              </a>
            </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="pricing-card">
              ...
              <p class="description">O plano Basic irá atender bem o seu negócio, trazendo um número interessante de imagens a serem incorporadas ao seu tour!</p>

              <h4>Funcionalidades:</h4>
              <ul class="features-list">
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 50 tours virtuais
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 20 imagens por tour
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 3000 conexões
                </li>
                <li>
                  <i class="bi bi-check-circle-fill"></i>
                  Total de 1000 POI's
              ...
              <a href="https://api.whatsapp.com/send?phone=5585998660078" target="_blank" class="btn btn-primary">
                Comprar
                <i class="bi bi-arrow-right"></i>
              </a>
            </div>
    ...
    <!-- Faq Section -->
    <section id= "faq" class="faq-9 faq section light-background" id="faq">

      <div class="container">
        <div class="row">

          <div class="col-lg-5" data-aos="fade-up">
            <h2 class="faq-title">Ficou com alguma dúvida? Nós te ajudamos!</h2>
            <p class="faq-description">A sua dúvida pode já ter sido a de outra pessoa! Confira ao lado as perguntas mais frequentes e encontre respostas rápidas e claras. Se ainda precisar de ajuda, entre em contato conosco.</p>
          ...
          <div class="col-lg-7" data-aos="fade-up" data-aos-delay="300">
            <div class="faq-container">
              ...
              <div class="faq-item">
                <h3>Pra quem é o 360° Listados?</h3>
                <div class="faq-content">
                  <p>O 360° Listados é ideal para quem deseja destacar espaços e criar experiências imersivas, como:
                    <br></br>
                    <strong>Imobiliárias e Corretores:</strong> Apresente imóveis de forma inovadora, atraindo mais clientes.<br></br>
                    <strong>Arquitetos e Designers:</strong> Mostre projetos com realismo e detalhes impressionantes.<br></br>
                    <strong>Vistorias de Obras:</strong> Documente o progresso de construções com clareza.<br></br>
                    <strong>Empresas e Instituições:</strong> Promova escritórios, espaços culturais e educacionais de forma envolvente.
                  </p>
                </div>
              ...
              <div class="faq-item">
                <h3>Como o 360° Listados ajuda a divulgar meu negócio?</h3>
                <div class="faq-content">
                  <p>O 360° Listados oferece uma experiência imersiva que permite explorar imóveis de qualquer lugar e a qualquer momento. Os tours virtuais destacam informações importantes e podem ser facilmente compartilhados nas redes sociais, ampliando o alcance e atraindo mais clientes de forma prática e inovadora.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Quais câmeras são compatíveis com o 360° Listados?</h3>
                <div class="faq-content">
                  <p>Os nosso clientes podem utilizar as seguintes câmeras:
                    Insta360 (One RS 1 - Inch 360)<br></br>
                    Insta360 (One RS)<br></br>
                    Insta360 (One X / X2 / X3)<br></br>
                    Ricoh (Theta Z1)<br></br>
                    Ricoh (Theta X)<br></br>
                    Ricoh (Theta SC2)<br></br>
                    Trisio (Lite 2)<br></br>
                  </p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              ...
              <div class="faq-item">
                <h3>Os tours virtuais podem ser compartilhados nas redes sociais?</h3>
                <div class="faq-content">
                  <p>Sim! Após a criação de seus tours virtuais, o cliente poderá compartilhá-los em seus redes sociais como Whatsapp, Facebook, Twitter (X), Linkedin, Telegram, e vários outros.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Quais tipos de imóveis podem ser beneficiados com tours virtuais?</h3>
                <div class="faq-content">
                  <p>Qualquer imóvel pode ter seu próprio tour virtual! Basta o usuário ter vontade de divulgá-lo de uma forma totalmente inovadora, prática e de fácil acesso.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Existe algum período de teste para experimentar a ferramenta?</h3>
                <div class="faq-content">
                  <p>Claro que sim! Disponibilizamos aos nossos futuros clientes o Plano Free, onde é possível acessá-lo durante 90 dias, com este acesso os usuários podem conhecer as funcionalidades do 360° Listados, criar tours virtuais e personalizá-los.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
        ...
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-9">
            <div class="text-center">
              <h3>Listados</h3>
              <p>A Listados atua no mercado imobiliário com o objetivo de se tornar o maior portal do ramo no Brasil, oferecendo produtos inovadores. Focamos em transformar a experiência do usuário, proporcionando soluções que otimizam a apresentação de imóveis e agilizam os processos. Nosso compromisso é atender as necessidades de imobiliárias, corretores e profissionais do setor com qualidade e inovação, moldando o futuro do mercado imobiliário no país.</p>
              <a class="cta-btn" href="https://www.listados.com.br/" target="_blank">Ir ao Listados</a>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-7">
        <div class="col-lg-8 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">360° Listados</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Ary Barroso N° 70</p>
            <p>Fortaleza, CE</p>
            <p class="mt-3"><strong>Telefone</strong> <span>+55 85 99866-0078</span></p>
            <p><strong>Email:</strong> <span>contato@listados.com.br</span></p>
          </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Listados</strong> <span>Todos os Direitos Reservados</span></p>
    </div>
