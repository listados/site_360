        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col  d-flex align-items-center">
                <div class="header-container container-fluid container-xl position-relative justify-content-between">
              ...
              <div class="col d-flex align-items-center">
                <nav class="container-fluid container-xl position-relative">
                    <div class="row">
                        <div class="col">
                            <a href="https://360.listados.com.br/backend/login.php" 
                            target="_blank">Entrar</a>
                    
                        </div>
                        <div class="col">
                            <a class="d-none d-sm-block" 
                                href="https://360.listados.com.br/backend/register.php" 
                                target="_blank">
                                Cadastrar
                            </a>  
                        </div>
